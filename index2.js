"use strict";
        $(document).ready(function() {
            ...
            //prompts user for their lucky number
            ...
            if (number >= 0) {
                ...
                $("#quotes").html("The message on your t-shirt will be: " + quote[end_quote]); //printing user quote based on number
            } else {
                alert("Your lucky number must be greater than or equal to zero."); //user must enter a number or they receive alert
            }
        });
